...
@pytest.fixture
def transactions_1() -> list[dict[str, Any]]:
...
@pytest.fixture
def currency_rur() -> str:
    """Фикстура для filter_by_currency"""
    return "RUR"


@pytest.fixture
def transactions_usd1() -> dict:
    """Фикстура для filter_by_currency"""
    return {
        "id": 939719570,
        "state": "EXECUTED",
...
@pytest.fixture
def transactions_not_operationamount() -> list[Any]:
    """Фикстура для filter_by_currency"""
    return [
        {
            "id": 939719570,
...
# Фикстуры для utils_table.py


@pytest.fixture
def expected_data_table_csv() -> list[dict]:
    """Фикстура для transactions_data_csv"""
    return [
        {
            "id": 650703,
            "state": "EXECUTED",
...
@pytest.fixture
def expected_data_table_xlsx() -> list[dict]:
    """Фикстура для transactions_data_csv"""
    return [
        {
            "id": 650703,
...
@pytest.fixture
def test_list_regex() -> list[dict]:
    """Фикстура для process_bank_search и process_bank_operations"""
    return [
        {
            "id": 142264268,
            "state": "EXECUTED",
...
@pytest.fixture
def categories_regex1() -> list:
    """Фикстура для process_bank_search"""
    return ["Открытие вклада", "Перевод организации", "Перевод со счета на счет"]


@pytest.fixture
def categories_regex2() -> list:
    """Фикстура для process_bank_search"""
    return ["перевод", "вклад", "организации"]


@pytest.fixture
def categories_regex3() -> list:
    """Фикстура для process_bank_search"""
    return ["Кредит", "Зарплата", "Оплата"]
